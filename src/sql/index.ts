...
const QUERY_FILES = {
  ...
  governance_dreps_drep_id_updates_unpaged: 'governance/unpaged/dreps_drep_id_updates.sql',
  governance_dreps_drep_id_votes: 'governance/dreps_drep_id_votes.sql',
  governance_dreps_drep_id_votes_unpaged: 'governance/unpaged/dreps_drep_id_votes.sql',
  governance_proposals: 'governance/proposals.sql',
  governance_proposals_unpaged: 'governance/unpaged/proposals.sql',
  governance_proposals_proposal: 'governance/proposals_proposal.sql',
  ...
  governance_proposals_proposal_withdrawals_unpaged:
    'governance/unpaged/proposals_proposal_withdrawals.sql',
  ...
  pools_pool_id_votes: 'pools/pools_pool_id_votes.sql',
